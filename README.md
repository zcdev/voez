...
An experimental browser-based voice interface that explores speech recognition, AI reasoning, voice synthesis, and music playback using modern web technologies: [https://voez.ai](https://voez.ai)
