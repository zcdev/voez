...
export default function SongItem({ song, selectedSong, isPlaying, isShowPlayer, duration, currentTime, onClick }: SongProps) {
    ...
    return (
        <>
            <li className={`rounded-xl ${isPlaying && song.id === selectedSong ? "shadow-[0px_0px_5px_1px_rgba(0,_0,_0,_0.4)] scale-125 m-3" : "shadow-lg"}`}>
                <div>
                    <Image
                ...
                <div className="bg-gray-400 pl-[8px] pr-2 py-2 rounded-b-xl text-white text-left">
